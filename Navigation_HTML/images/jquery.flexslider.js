    ...
    $.flexslider = function(el, options) {
        ...
        slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
            if(!vars.albumSlider)
            {
                ...
                //Events tracking
                                  if(slider.parents('.article-flexSlide').attr('class')){
                                      if (slider.direction == 'next'){
                                          _gaq.push(['_trackEvent', 'Article Slider', 'Next', 'Next button is clicked']);
                                      }
                                      else if (slider.direction == 'prev'){
                                          _gaq.push(['_trackEvent', 'Article Slider', 'Previous', 'Previous button is clicked']);
                                      }
                                  }
                                  

                                  if (slider.parents('#events-albums-slider').attr('id') == 'events-albums-slider'){
                                      if (slider.direction == 'next'){
                                          _gaq.push(['_trackEvent', 'Album Slider', 'next', 'Next button is clicked']);

                                      }
                                      else if (slider.direction == 'prev'){
                                          _gaq.push(['_trackEvent', 'Album Slider', 'previous', 'Previous button is clicked']);
                                      }
                                  }
                                  
                                  if (slider.parents('.view-slider').attr('class')){
                                      if (slider.direction == 'next'){
                                          _gaq.push(['_trackEvent', 'Main Slider Tablet', 'next', 'Next button is clicked']);

                                      }
                                      else if (slider.direction == 'prev'){
                                          _gaq.push(['_trackEvent', 'Main Slider Tablet', 'previous', 'Previous button is clicked']);
                                      }
                                      
                                      var currentTrack = target + 1;
                                        _gaq.push(['_trackEvent', 'Main Slider Tablet', 'slider-'+currentTrack, 'slide has been visited']);
                                  }
                ...
                if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
                    if (asNav && withSync) {
                        ...
                        if(master.parents('.my-corner').length > 0){
                            activeItem = target;
                        }
